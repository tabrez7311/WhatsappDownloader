package com.july.tab.whatsappdownloader.adapter;
...
import com.july.tab.whatsappdownloader.R;
...
public class RecyclerViewMediaAdapter extends RecyclerView.Adapter<RecyclerViewMediaAdapter.FileHolder> {
    ...
    private static String DIRECTORY_TO_SAVE_MEDIA_NOW = "/storage/emulated/legacy/Whatsapp Status/";
    ...
    public void onBindViewHolder(final RecyclerViewMediaAdapter.FileHolder holder, int position) {
        ...
        long lastTime=currentFile.lastModified();
        String displayTime=getTimeAgo(lastTime);
        ...
        holder.buttonShareImage.setOnClickListener(this.shareImageMedia(currentFile));
        holder.buttonShareVideo.setOnClickListener(this.shareVideoMedia(currentFile));
        ...
        if (currentFile.getAbsolutePath().endsWith(".mp4")) {
            ...
            holder.videotimetext.setText(displayTime);
            ...
            holder.imagetimetext.setText(displayTime);
        }
    ...
    public static class FileHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TextView imagetimetext;
        TextView videotimetext;
        Button buttonShareImage;
        Button buttonShareVideo;
        ...
        public FileHolder(View itemView) {
            ...
            imagetimetext=(TextView) itemView.findViewById(R.id.imagetimetext);
            videotimetext=(TextView) itemView.findViewById(R.id.videotimetext);
            buttonShareImage=(Button)itemView.findViewById(R.id.buttonImageShare);
            buttonShareVideo=(Button)itemView.findViewById(R.id.buttonVideoShare);
